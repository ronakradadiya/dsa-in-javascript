class Solution 
{
    ...
    maxProfit(weights, profit, currentItem, capacity, n) {
        if (currentItem === n) {
            return 0;
        }
        ...
        if (currentItemWeight <= capacity) {
            consider = currentItemProfit + this.maxProfit(weights, profit, currentItem + 1, capacity - currentItemWeight, n)
        }
        const notConsider = this.maxProfit(weights, profit, currentItem + 1, capacity, n);
